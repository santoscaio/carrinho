...
$busca = mb_strtolower(trim($_POST['busca']));

$query0 = $buscaObj->queryProdutos($busca);
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">Resultado de busca por "<?php echo $_POST['busca']; ?>"</h1>
