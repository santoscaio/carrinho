...
include('class/categoriaClass.php');
...
$query0 = $categoriaObj->queryProdutos($idCat);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    ...
                    <ul class="nav nav-sidebar">
                        <?php
                        $nomeCat = 'Categoria não encontrada.';
                        while ($resultado1 = mysql_fetch_assoc($executar1['result'])) {
                            if ($idCat == $resultado1['id']) {
                                $select = 'class="active"';
                                $nomeCat = $resultado1['nome'];
                            } else {
                                $select = '';
                            }
                            ?>
                            <li <?php echo $select; ?>><a href="categoria.php?i=<?php echo $resultado1['id']; ?>"><?php echo $resultado1['nome']; ?></a></li>
                        <?php } ?>
                    </ul>
                    <ul class="nav nav-sidebar">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header"><?php echo $nomeCat; ?></h1>
